export default function Loading() {
  return (
    <div className="bg-light dark:bg-dark fixed inset-0 z-200 flex h-dvh items-center justify-center">
      <div className="relative mt-8 flex h-80 items-center justify-center overflow-hidden">
        {/* Glow background */}
