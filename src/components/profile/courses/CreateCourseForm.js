...
export default function CreateCourseForm() {
  ...
  useEffect(() => {
    async function loadCategories() {
      try {
        ...
        toast.error(error?.message || "دریافت دسته‌بندی‌ها با خطا مواجه شد.");
      } finally {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (!result?.success) {
        throw new Error("ساخت دوره با خطا مواجه شد.");
      }
      ...
      const message = error?.message || "ساخت دوره با خطا مواجه شد.";
      ...
      >
        ...
        <section className="bg-light dark:bg-dark rounded-xl p-5 sm:p-6">
          <div className="mb-5">
            ...
            <p className="text-dark/50 dark:text-light/50 mt-1 text-xs">
              توضیحات کوتاه و معرفی دوره را وارد کنید.
            </p>
          </div>
        ...
        <section className="bg-light dark:bg-dark rounded-xl p-5 sm:p-6">
          <div className="mb-5">
            ...
            <p className="text-dark/50 dark:text-light/50 mt-1 text-xs">
              دسته‌بندی و دوره پیش‌نیاز این دوره را مشخص کنید.
            </p>
          </div>
        ...
        <section className="bg-light dark:bg-dark rounded-xl p-5 sm:p-6">
          <div className="mb-5">
            ...
            <p className="text-dark/50 dark:text-light/50 mt-1 text-xs">
              محتوای Tiptap دوره را به صورت JSON وارد کنید.
            </p>
          </div>
          ...
          <div className="bg-primary/5 mt-3 flex flex-col gap-2 rounded-xl p-4 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-dark/50 dark:text-light/50 text-xs leading-6">
              برای ساخت و دریافت JSON محتوای دوره می‌توانید از ویرایشگر Tiptap
              استفاده کنید.
            </p>
