      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-3 xl:block">
          ...
          <AddToCartButton
            courseId={course.id}
            isFree={finalPrice === 0}
            className="bg-primary hover:bg-primary/90 flex h-11 w-full shrink-0 items-center justify-center gap-2 rounded-lg px-5 text-sm font-semibold text-white transition-colors xl:w-full"
          />
        </div>
      </div>
    </div>
